...
namespace ESTMS.API.DataAccess.Migrations
{
    ...
    [Migration("20230430132610_MadeApplicationUserNewFieldsNullable")]
    partial class MadeApplicationUserNewFieldsNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ESTMS.API.DataAccess.Entities.PlayerScore", b =>
                {
                    ...
                    b.HasOne("ESTMS.API.DataAccess.Entities.Player", "Player")
                        .WithMany("Scores")
